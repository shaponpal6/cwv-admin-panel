...
function ClientDetailsContainer(props) {
    ...
    return (
        <header className="cwv-UMCHeader">
            ...
            <Button className="cwv-userInfoToggle" hover="no" icon="down" onClick={onMenuToggle} />
...
export default connect(mapStateToProps, mapDispatchToProps)((memo(ClientDetailsContainer)))
